...
const FIELDS = [
  ...
  { field: 'billing', label: 'Billing', type: 'text' },
  { field: 'garantie', label: 'Garantie', type: 'int' },
  { field: 'remarks_bac', label: 'Remarks bac', type: 'text' },
  { field: 'phone_include', label: 'Phone Include', type: 'int' },
  { field: 'ga', label: 'GA', type: 'text' },
  ...
  { field: 'contract_stop', label: 'Contract Stop', type: 'int' },
