...
export const FIELDS = [
  ...
  { key: 'garantie', label: 'Garantie', type: 'int' },
  { key: 'remarks_bac', label: 'Remarks bac', type: 'text' },
  { key: 'phone_include', label: 'Phone Include', type: 'int' },
  { key: 'ga', label: 'GA', type: 'text' },
  ...
  { key: 'contract_stop', label: 'Contract Stop', type: 'int' },
